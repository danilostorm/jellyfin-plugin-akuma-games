...
" || fail "o catálogo unificado para PC e Android não foi instalado corretamente."
...
echo "PC e Android agora usam o mesmo catálogo rápido e responsivo."
echo "Não é necessário sincronizar os games novamente."
echo "Feche todas as abas do Jellyfin; no Android, force a parada do aplicativo e abra novamente."
