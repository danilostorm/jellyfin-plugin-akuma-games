...
if [[ -f "${PLUGIN_DIR}/Jellyfin.Plugin.AkumaGames.dll" ]]; then
  cp -f "${PLUGIN_DIR}/Jellyfin.Plugin.AkumaGames.dll" \
    "${PLUGIN_DIR}/Jellyfin.Plugin.AkumaGames.dll.bak-v0.2.3.2"
fi
...
docker exec "${CONTAINER}" sh -c "
  ...
  cp -f '${WEB_INDEX}' '${WEB_INDEX}.akuma-backup-v0.2.3.2'
...
echo
echo "Akuma Games v0.2.3.2 instalado."
echo "Agora clicar na capa usa a mesma rota do título e abre o game HTML5."
